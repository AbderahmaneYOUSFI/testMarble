  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-2N7S3UF6.js"),
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-47R5JJ6F.js"),
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-CNTSHAOR.js"), import("./depth.fragment-CCK5JDXU.js")]);
    } else {
...
//# sourceMappingURL=chunk-MIAXOAIL.js.map
