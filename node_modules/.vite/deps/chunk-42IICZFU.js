    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-6HOUJAN5.js"), import("./openpbr.fragment-SISWZUKW.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-GSZ5SET3.js"), import("./openpbr.fragment-PNCC2D4B.js")]);
        }
...
//# sourceMappingURL=chunk-42IICZFU.js.map
