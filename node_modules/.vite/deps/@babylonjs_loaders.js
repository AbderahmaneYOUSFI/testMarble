import {
  ...
  getVector3,
  getWeights
} from "./chunk-IEXH76C6.js";
import {
  OpenPBRMaterialLoadingAdapter
} from "./chunk-BX7RWI2F.js";
import {
  PBRMaterialLoadingAdapter
} from "./chunk-GWRJYEMH.js";
import {
  FlowGraphGLTFDataProvider
} from "./chunk-WXYVD3BV.js";
import {
  AnimationEvent,
  AssetContainer,
  DataReader,
...
import "./chunk-AXH4XRS4.js";
import "./chunk-F3HZOEDN.js";
import "./chunk-PP2OEPRQ.js";
import {
...
import "./chunk-C2HNDA4N.js";
import "./chunk-FVYIFR4C.js";
import "./chunk-BQYG64FD.js";
import "./chunk-U5WFNWH6.js";
import "./chunk-Q5VTOXVS.js";
import "./chunk-N24WA5HD.js";
import "./chunk-YP4SCFLZ.js";
...
import "./chunk-2OQWXOES.js";
import "./chunk-XPKV3BXW.js";
import "./chunk-RKQ7VX5C.js";
import {
  Camera,
  DirectionalLight,
  Material
...
import "./chunk-4AXKQXFO.js";
import {
  BoundingInfo,
  SubMesh
} from "./chunk-OK5RZGZM.js";
import "./chunk-P7ZZDP3F.js";
import "./chunk-WKXRXUEO.js";
import "./chunk-SR6BRXYM.js";
import "./chunk-J6KHPZGE.js";
import "./chunk-SFAN2GJU.js";
import "./chunk-GFXF2AHA.js";
import "./chunk-B5BNMDKA.js";
...
import "./chunk-3VHYKU5T.js";
import "./chunk-5QARBLQA.js";
import "./chunk-UGBR7FXY.js";
import {
  RenderTargetTexture,
  SphericalHarmonics,
  SphericalPolynomial
} from "./chunk-JHGSVJX6.js";
import "./chunk-AVMKLHDK.js";
import "./chunk-W6O4MGKY.js";
import "./chunk-LJSODA3L.js";
import "./chunk-WAGTS43G.js";
import {
  Texture
} from "./chunk-GOQF7HQ5.js";
import "./chunk-MS6BD2HN.js";
import {
  Color3,
  Color4
...
import "./chunk-HUJL7WJM.js";
import "./chunk-5SZIQFNV.js";
import {
  Tools
} from "./chunk-KRWR4V4J.js";
import "./chunk-PBOANBK7.js";
import {
  Buffer,
...
var LazyAnimationGroupModulePromise = new Lazy(() => import("./animationGroup-HDA7IS7C.js"));
var LazyLoaderAnimationModulePromise = new Lazy(() => import("./glTFLoaderAnimation-NY7Q6OST.js"));
var ArrayItem = class {
  /**
      ...
      if (!this.parent.skipMaterials && this._pbrMaterialImpl == null) {
        if (this.parent.useOpenPBR || this.isExtensionUsed("KHR_materials_openpbr")) {
          this._pbrMaterialImpl = {
            materialClass: (await import("./openpbrMaterial-AZ5EUJ67.js")).OpenPBRMaterial,
            adapterClass: (await import("./openpbrMaterialLoadingAdapter-C66PPU7I.js")).OpenPBRMaterialLoadingAdapter
          };
        } else {
          this._pbrMaterialImpl = {
            materialClass: (await import("./pbrMaterial-X4UOJBRJ.js")).PBRMaterial,
            adapterClass: (await import("./pbrMaterialLoadingAdapter-M6LDKNBA.js")).PBRMaterialLoadingAdapter
          };
        }
      }
...
var NAME25 = "KHR_materials_dispersion";
...
registerGLTFExtension(NAME25, true, (loader) => new KHR_materials_dispersion(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_diffuse_roughness.js
var NAME26 = "KHR_materials_diffuse_roughness";
...
registerGLTFExtension(NAME26, true, (loader) => new KHR_materials_diffuse_roughness(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_mesh_quantization.js
var NAME27 = "KHR_mesh_quantization";
var KHR_mesh_quantization = class {
  ...
  constructor(loader) {
    this.name = NAME27;
    this.enabled = loader.isExtensionUsed(NAME27);
  }
  /** @internal */
  dispose() {
  }
...
registerGLTFExtension(NAME27, true, (loader) => new KHR_mesh_quantization(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_texture_basisu.js
var NAME28 = "KHR_texture_basisu";
...
registerGLTFExtension(NAME28, true, (loader) => new KHR_texture_basisu(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_texture_transform.js
var NAME29 = "KHR_texture_transform";
...
registerGLTFExtension(NAME29, true, (loader) => new KHR_texture_transform(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_xmp_json_ld.js
var NAME30 = "KHR_xmp_json_ld";
...
registerGLTFExtension(NAME30, true, (loader) => new KHR_xmp_json_ld(loader));
...
var NAME31 = "KHR_animation_pointer";
var KHR_animation_pointer = class {
   ...
   */
  get enabled() {
    return this._loader.isExtensionUsed(NAME31);
  }
  /** @internal */
  dispose() {
    this._loader = null;
...
registerGLTFExtension(NAME31, true, (loader) => new KHR_animation_pointer(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_audio_emitter.js
var NAME32 = "MSFT_audio_emitter";
...
registerGLTFExtension(NAME32, true, (loader) => new MSFT_audio_emitter(loader));
...
var MSFT_lod = class {
  ...
  constructor(loader) {
    ...
    this._loader = loader;
    this.maxLODsToLoad = this._loader.parent.extensionOptions[NAME33]?.maxLODsToLoad ?? this.maxLODsToLoad;
...
registerGLTFExtension(NAME33, true, (loader) => new MSFT_lod(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_minecraftMesh.js
var NAME34 = "MSFT_minecraftMesh";
...
registerGLTFExtension(NAME34, true, (loader) => new MSFT_minecraftMesh(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_sRGBFactors.js
var NAME35 = "MSFT_sRGBFactors";
...
registerGLTFExtension(NAME35, true, (loader) => new MSFT_sRGBFactors(loader));
...
addToBlockFactory(NAME36, "FlowGraphGLTFDataProvider", async () => {
  return (await import("./flowGraphGLTFDataProvider-P2D74KCN.js")).FlowGraphGLTFDataProvider;
});
unregisterGLTFExtension(NAME36);
registerGLTFExtension(NAME36, true, (loader) => new KHR_interactivity(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_node_visibility.js
var NAME37 = "KHR_node_visibility";
...
registerGLTFExtension(NAME37, true, (loader) => new KHR_node_visibility(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_node_selectability.js
var NAME38 = "KHR_node_selectability";
addNewInteractivityFlowGraphMapping("event/onSelect", NAME38, {
...
registerGLTFExtension(NAME38, true, (loader) => new KHR_node_selectability(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_node_hoverability.js
var NAME39 = "KHR_node_hoverability";
var MeshPointerOverPrefix = "targetMeshPointerOver_";
addNewInteractivityFlowGraphMapping("event/onHoverIn", NAME39, {
  // using GetVariable as the nodeIndex is a configuration and not a value (i.e. it's not mutable)
...
addNewInteractivityFlowGraphMapping("event/onHoverOut", NAME39, {
  // using GetVariable as the nodeIndex is a configuration and not a value (i.e. it's not mutable)
...
registerGLTFExtension(NAME39, true, (loader) => new KHR_node_hoverability(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/ExtrasAsMetadata.js
var NAME40 = "ExtrasAsMetadata";
...
registerGLTFExtension(NAME40, false, (loader) => new ExtrasAsMetadata(loader));
