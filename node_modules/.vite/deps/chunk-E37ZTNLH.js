    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-HUS2NP46.js"), import("./pbr.fragment-QCPAYF23.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-UIT4D6WS.js"), import("./pbr.fragment-FYJ3K6HD.js")]);
        }
...
//# sourceMappingURL=chunk-E37ZTNLH.js.map
